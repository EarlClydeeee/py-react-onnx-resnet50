...
export function validateBrainMRI(image) {
  ...
  // Mildly colorful — warn but allow
  if (avgSaturation > 0.18) {
    return {
      status: "warning",
      score: qualityScore,
      reason:
        "This image has more color than a typical MRI scan. Results may be unreliable. Upload a grayscale brain MRI for best accuracy.",
    };
  }
